...
const SCHEMA = [
  {
    ...
    fields: [
      ...
      { key: 'active_border_2', label: 'Active border (gradient end)', hypr: 'general:col.active_border', type: 'color', default: '#00ff99', role: 'gradient-end' },
      { key: 'active_border_angle', label: 'Gradient angle', hypr: 'general:col.active_border', type: 'slider', min: 0, max: 360, step: 5, default: 45, unit: '°', role: 'gradient-angle' },
